            ...
            <ul className="flex items-center gap-6 lg:gap-10">
              {navLinks.map((link) => {
                ...
                <li key={link.name} className={link.name === "SERVICES" ? "relative group" : ""}>
                  <Link
                    href={link.href}
                    className={`flex items-center gap-1 text-xs lg:text-sm font-sans font-medium tracking-[0.15em] transition-colors duration-300 relative group-hover:text-[#C5A367] ${
                      isActive && link.name !== "SERVICES"
                  ...
                  >
                    ...
                    <span
                      className={`absolute -bottom-2 left-1/2 -translate-x-1/2 h-0.5 rounded-full bg-[#C5A367] transition-all duration-300 ${
                        isActive && link.name !== "SERVICES" ? "w-1/2" : "w-0 group-hover:w-1/2"
                      }`}
                    ></span>
                  </Link>
